...
org.goorm.core.dialog.alert.prototype = {
	init: function () {
		...
		this.buttons = [{ text: "<span localization_key='ok'>OK</span>", handler: handle_yes, isDefault: true }];
		...
		container.find('.yui-button button').attr('id', 'g_a_btn_ok');
	},
	...
	show: function (message) {
		...
		panelContainer_bd.append(this.message).prepend("<div class='alert_image_div'><img src='" + this.image_url + "'/></div>").css("text-align", "left");
