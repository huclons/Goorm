...
org.goorm.core.dialog.notice.prototype = {
	...
	init: function () {
		...
		this.title = "Notice";
		this.imageURL = "images/org.goorm.core.dialog/dialog_notice.png";
	...
	show: function (message) {
		...
		$("#panelContainer_" + this.title).find(".bd").prepend("<div class='noticeImageDIV'><img src='"+this.imageURL+"'/></div>");
