	...
	new_project: function(data) {
		...
		*/
		...
		case "C Console Project": 
			...
			data.plugins["org.goorm.plugin.cpp"]["plugin.cpp.main"] = "main";
			break;
		case "C++ Console Project": 
...
//		});
	...
	build: function (projectName,callback) {
		...
		var MakeFilePath = plugin['plugin.cpp.makefile_path'];
		...
		buildPath_guarantee_cmd+= 'if [ ! -d '+workspace+projectName+'/'+plugin['plugin.cpp.build_path']+' ];';
		buildPath_guarantee_cmd+= 'then mkdir -p '+workspace+projectName+'/'+plugin['plugin.cpp.build_path']+';';
		buildPath_guarantee_cmd+= 'fi;clear;\n\r';

		core.module.layout.terminal.send_command('\n\r', null);
		core.module.layout.terminal.send_command(buildPath_guarantee_cmd, null);
		core.module.layout.terminal.send_command(cmd+'\n\r', null, function(result){
