//DB 연결을 전역객체로 선언. DAO를 사용하는 모든 객체보다 앞에 나와야 한다.
mongoose = require('mongoose');
Schema = mongoose.Schema;
mongoose.connect('mongodb://localhost/stellaboard');
...
goorm.configure(function(){
  ...
  goorm.use(express.session({
  			 secret : 'skima2049q935435uwp94ut'
  			,store : new mongo_store({url : 'mongodb://localhost/stellaboard', maxAge : 600000})
